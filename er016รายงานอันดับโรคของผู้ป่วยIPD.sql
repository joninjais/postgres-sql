--er016รายงานอันดับโรคของผู้ป่วยIPDปีงบ 59
...
where 
 t_visit.f_visit_status_id <> '4' and  t_visit.f_visit_type_id = '1' --เลือก 1 ผู้ป่วยใน 0 ผู้ป่วยนอก					 
 and substring(t_visit.visit_begin_visit_time,1,10) between substring('2550-10-01',1,10) AND substring('2560-01-31',1,10)
