...
AND ((b_service_point.b_service_point_id)='2060761082126')  --เปลี่ยนรหัส เป็นรหัสจุดบริการที่ต้องการ
...
, b_service_point.b_service_point_id , t_visit_service.visit_service_staff_doctor ,t_visit.visit_financial_discharge_time,dx ,ยอดรวม
