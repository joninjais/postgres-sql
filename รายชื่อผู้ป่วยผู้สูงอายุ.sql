...
substr(t_visit.visit_begin_visit_time,1,10) between  substring('2560-02-01',1,10) and substring('2560-02-28',1,10)
--substr(t_visit.visit_begin_visit_time,1,10) between  substring(?,1,10) and substring(?,1,10)
and
--b_contract_plans.contract_plans_pttype = 'A4'
b_contract_plans.contract_plans_description like '%ผู้สูงอายุ%'
