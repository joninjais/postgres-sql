--er024รายชื่อผู้ป่วยที่กู้ภัยEMSนำส่ง
select distinct 
...
where  (t_visit_primary_symptom.visit_primary_symptom_current_illness ilike ('%oscc%') 
or visit_primary_symptom_main_symptom ilike ('%oscc%') )
and t_visit.f_visit_status_id <> '4'	
and substring(t_visit.visit_begin_visit_time,1,10) between substring('2556-10-01',1,10) AND substring('2560-09-30',1,10)
