...
where substring(t_visit_refer_in_out.record_date_time,1,10) between substring('2555-10-01',1,10) AND substring('2556-09-30',1,10)
and t_visit.f_visit_type_id = '1'
--where t_visit_refer_in_out.record_date_time like '2552-08%'

ORDER BY t_visit_refer_in_out.record_date_time) as q