--ER043 รายชื่อผู้ป่วย appendicitis (ใส้ติ่งอักเสบ) ที่เข้า ER
select DISTINCT t_patient.patient_hn AS hn  ,t_visit.visit_vn AS VN
...
where t_diag_icd10.diag_icd10_number like 'K35%'
