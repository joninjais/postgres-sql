...
,(SELECT school_class_description
...
AS school_class_number
FROM b_school_class 
WHERE t_health_visit_school.b_school_class_id = b_school_class.b_school_class_id ) AS CLASSnumber
,t_health_student.student_pid AS ID
--,'20160321145508' as D_UPDATE
,t_patient.patient_hn as hn
,t_health_student.student_firstname as f_name
,t_health_student.student_surname as l_name
...
--and t_health_family.health_family_hn_hcis is null
