...
or visit_primary_symptom_main_symptom ilike ('%กู้%') )
and t_visit.f_visit_status_id <> '4'	
and substring(t_visit.visit_begin_visit_time,1,10) between substring('2559-10-01',1,10) AND substring('2559-10-31',1,10)
