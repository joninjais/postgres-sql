...
,substring(t_visit.visit_begin_visit_time,1,10) as วันรับ
,t_visit_refer_in_out.refer_date as วันส่ง
...
where
substring(t_visit_refer_in_out.record_date_time,1,10) between substring('2559-12-01',1,10) AND substring('2559-12-31',1,10)
--where t_visit_refer_in_out.record_date_time like '2552-08%'
and  substring(t_visit.visit_begin_visit_time,1,10) <> t_visit_refer_in_out.refer_date
