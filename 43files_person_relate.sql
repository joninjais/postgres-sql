...
where 
         ...
         and b_site.b_visit_office_id||'|'||t_health_family.health_family_hn_hcis in (:in_pk)
         and b_site.b_visit_office_id||'|'||t_health_family.health_family_hn_hcis not in (:notin_pk)  
