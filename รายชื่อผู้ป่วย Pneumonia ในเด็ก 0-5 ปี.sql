...
where (t_diag_icd10.diag_icd10_number like 'J18%'
			or t_diag_icd10.diag_icd10_number like 'J18%'
)
and t_visit.visit_patient_age in ('0','1','2','3','4','5')
and t_visit.f_visit_type_id = '1'
--and t_visit.f_visit_type_id = '1'
and substring(t_visit.visit_begin_visit_time,1,10) between substring('2559-10-01',1,10) AND substring('2559-12-31',1,10)
